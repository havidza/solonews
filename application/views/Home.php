...
<!-- <div class="card">
			<div class="card-body">
				Selamat Datang di Website SoloNews, Selamat Membaca !
				<img src="<?php echo base_url('assets/images/logo.png') ?>" width="10%" style="float: right;">
			</div>	
		</div>
		<br>
		 -->
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img class="d-block w-100" src="<?php echo base_url('assets/images/img1.jpeg') ?>" alt="First slide">
					    </div>
					    <div class="carousel-item">
					      <img class="d-block w-100" src="<?php echo base_url('assets/images/img5.jpeg') ?>" alt="Second slide">
					    </div>
					    <div class="carousel-item">
					      <img class="d-block w-100" src="<?php echo base_url('assets/images/img7.jpg') ?>" alt="Third slide">
					    </div>
					  </div>
				...
				<div class="berita">
						...
						<p align="justify"><?php echo $b->headline ?></p>
						<a href="<?php echo base_url(). ''.$b->link ?>"><button type="button" class="btn btn-outline-info">Read More</button></a> <br><br>
						<hr>
							<br>	
