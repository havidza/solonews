	...
	<div class="row">
	  <div class="col-md">
		 <h1 class="mt-4">Berita</h1>
              <br>
              <a href="<?php echo base_url('berita/tambah')?>">
                ...
                <?php 
                   $no = 1;
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo base_url('assets/images/'.$ber->gambar) ?>" width="110%"></td>
                        <td><?php echo $ber->waktu_terbit ?></td>
                        <td><?php echo $ber->isi ?></td>
                        <td><?php echo $ber->headline ?></td>
                        <td><?php echo $ber->link ?></td>
                        <td><?php echo $ber->nama ?></td>
                        <td><?php echo $ber->jenis  ?></td>
                        <td>
                        <a href="<?php echo base_url('berita/edit/'.$ber->id)?>">
                          <button class="btn btn-primary">Edit</button>
                          </a>

                            <a href="<?php echo base_url('berita/hapus/'.$ber->id)?>">
