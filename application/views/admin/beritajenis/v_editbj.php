		...
		<h1 class="mt-4">Tambah Data Jenis Berita</h1>
              ...
              <!-- Untuk membuat border kotak pada content  -->
				...
				<div class="card-body">
				 ...
				 <!-- Mulai Form -->
					<form action="<?php echo base_url(). 'beritajenis/update'; ?>" method="post">
						<div class="form-group row">
							<label for="inputJudul" class="col-sm-2 col-form-label">Jenis Berita</label>
							<div class="col-sm-10">
                            <input type="hidden" name="id" value="<?php echo $bj->id ?>">
								<input type="text" class="form-control" name="judul" value="<?php echo $bj->judul ?>" required="required">
							</div>
						</div>
