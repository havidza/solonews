				 ...
				 <!-- Mulai Form -->
					<form action="<?php echo base_url(). 'berita/tambah_aksi'; ?>" method="post">
						...
						<input type="hidden" name="id" value="<?php echo $b->id ?>">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="judul" value="<?php echo $b->judul ?>" required="required">
							</div>
							<label for="inputJudul" class="col-sm-2 col-form-label">Gambar</label>
							<div class="col-sm-10">
								<input type="file" class="form-control" name="gambar" value="<?php echo $b->gambar ?>" required="required">
							</div>
							<label for="inputJudul" class="col-sm-2 col-form-label">Waktu Terbit</label>
							<div class="col-sm-10">
								<input type="date" class="form-control" name="waktu_terbit" value="<?php echo $b->waktu_terbit ?>" required="required">
							</div>
							<label for="inputJudul" class="col-sm-2 col-form-label">Isi</label>
							<div class="col-sm-10">
							<textarea name="isi" id="mytextarea" class="form-control" value="<?php echo $b->isi ?></textarea>
							</div>
							<label for="inputJudul" class="col-sm-2 col-form-label">Headline</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="headline" value="<?php echo $b->headline ?>" required="required">
							</div>
