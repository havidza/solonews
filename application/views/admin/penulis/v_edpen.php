		...
		<h1 class="mt-4">Edit Data Penulis</h1>
              ...
              <!-- Untuk membuat border kotak pada content  -->
				...
				<div class="card-body">
				 ...
				 <!-- Mulai Form -->
					<form action="<?php echo base_url(). 'penulis/update'; ?>" method="post">
						<div class="form-group row">
							<label for="inputJudul" class="col-sm-2 col-form-label">Nama</label>
							<div class="col-sm-10">
                            <input type="hidden" name="id" value="<?php echo $pen->id ?>">
								<input type="text" class="form-control" name="nama" value="<?php echo $pen->nama ?>" required="required">
                            </div>
                            <label for="inputJudul" class="col-sm-2 col-form-label">Telepon</label>
							<div class="col-sm-10">
                            <input type="hidden" name="id" value="<?php echo $pen->id ?>">
								<input type="text" class="form-control" name="telepon" value="<?php echo $pen->telepon ?>" required="required">
                            </div>
                            <label for="inputJudul" class="col-sm-2 col-form-label">Alamat</label>
							<div class="col-sm-10">
                            <input type="hidden" name="id" value="<?php echo $pen->id ?>">
								<input type="text" class="form-control" name="alamat" value="<?php echo $pen->alamat ?>" required="required">
                            </div>
                            <label for="inputJudul" class="col-sm-2 col-form-label">Email</label>
							<div class="col-sm-10">
                            <input type="hidden" name="id" value="<?php echo $pen->id ?>">
								<input type="text" class="form-control" name="email" value="<?php echo $pen->email ?>" required="required">
							</div>
						</div>
